   ...
   const handleChange = (e) => {
    ...
    const ProceedLoginusingAPI = (e) => {
        ...
        if (Object.keys(errors).length === 0) {
            let inputobj = { "correo" : inputFields.username, "contrasena": inputFields.password };
                            ...
                            <div className="form-inner">
                                ...
                                <form method="post" onSubmit={ProceedLoginusingAPI}>
                                    <div className="form-group">
                                        ...
                                        <input value={inputFields.username} onChange={handleChange} type="text" name="username" placeholder="Nombre de Usuario" />
                                        { errors.username ? (<small className="valid-alert" role="alert">{errors.username}</small>) : null}
                                    </div>

                                    <div className="form-group">
                                        <label>Contraseña</label>
                                        <input value={inputFields.password} onChange={handleChange} type="password" name="password" placeholder="Contraseña" />
                                        { errors.password ? (<small className="valid-alert" role="alert">{errors.password}</small>): null}
                                    </div>
